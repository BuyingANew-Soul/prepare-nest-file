...
var elementAndQuantity = {"P8_7_":quantity, "P1_7_":quantity, "P2_7_":quantity}

// read all the svg from file as string and put them in a list
var svgstring = svgFromFile('svgs/test svgs/bib2.svg') 
...
writeSvg(newsvg.svg(), "svgs/bib_output.svg");
